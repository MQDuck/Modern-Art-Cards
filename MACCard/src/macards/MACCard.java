...
{   
    ...
    public MACCard(final String fl, final String ttl, final String artst, final String stl, final String plc)
    {
        file = fl;
        title = ttl;
        artist = artst;
    ...
    public MACCard(final String fl, final String ttl, final String artst, final String stl)
    {
        file = fl;
        title = ttl;
        artist = artst;
